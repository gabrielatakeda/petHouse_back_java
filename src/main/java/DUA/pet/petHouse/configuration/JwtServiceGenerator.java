...
public class JwtServiceGenerator {
    ...
    // Parâmetros do token
    private static final String SECRET_KEY = "UMACHAVESECRETADASUAAPIAQUIUMACHAVESECRETADASUAAPIAQUIUMACHAVESECRETADASUAAPIAQUIUMACHAVESECRETADASUAAPIAQUI";
    ...
    public Map<String, Object> gerarPayload(UsuarioModel usuario) {
        ...
        payloadData.put("dataNascimento", usuario.getDataNascimento());
